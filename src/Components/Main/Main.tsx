...
const Main = () => {
  ...
  return (
    <main className="bg-white mt-10 px-6 py-8 flex flex-col gap-8 rounded-t-[25px] md:px-20 md:py-12 md:gap-10 md:rounded-[25px] md:min-w-[608px] md:mx-auto lg:flex-row lg:gap-12 lg:min-w-[920px] lg:p-8">
      <Form
